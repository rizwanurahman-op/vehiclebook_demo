...
export const createInvestment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const inv = await investmentService.create(req.body, req.adminId!);
...
export const listInvestments = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { data, meta } = await investmentService.list(req.query as Record<string, string>, req.adminId!);
...
export const getInvestment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const inv = await investmentService.getById(req.params.id as string, req.adminId!);
...
export const updateInvestment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const inv = await investmentService.update(req.params.id as string, req.body, req.adminId!);
...
export const deleteInvestment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        await investmentService.remove(req.params.id as string, req.adminId!);
...
export const getInvestmentsByLender = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { data, meta } = await investmentService.getByLender(req.params.lenderId as string, req.adminId!, req.query as Record<string, string>);
...
export const getInvestmentStats = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const stats = await investmentService.getStats({ mode: mode !== "all" ? mode : undefined, dateFrom, dateTo, lenderId, search }, req.adminId!);
...
export const exportInvestments = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const data = await investmentService.exportAll({ mode: mode !== "all" ? mode : undefined, dateFrom, dateTo, lenderId, search } as Record<string, string>, req.adminId!);
        ...
        const rows = (data as Record<string, unknown>[]).map(inv => [
            inv["Investment ID"], inv["Date"], inv["Lender Name"], inv["Lender ID"],
