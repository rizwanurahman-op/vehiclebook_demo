...
export const createRepayment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const rep = await repaymentService.create(req.body, req.adminId!);
...
export const listRepayments = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { data, meta } = await repaymentService.list(req.query as Record<string, string>, req.adminId!);
...
export const getRepayment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const rep = await repaymentService.getById(req.params.id as string, req.adminId!);
...
export const updateRepayment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const rep = await repaymentService.update(req.params.id as string, req.body, req.adminId!);
...
export const deleteRepayment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        await repaymentService.remove(req.params.id as string, req.adminId!);
...
export const getRepaymentsByLender = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { data, meta } = await repaymentService.getByLender(req.params.lenderId as string, req.adminId!, req.query as Record<string, string>);
...
export const getRepaymentStats = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const stats = await repaymentService.getStats({ mode: mode !== "all" ? mode : undefined, dateFrom, dateTo, lenderId, repaymentType: repaymentType !== "all" ? repaymentType : undefined, search }, req.adminId!);
...
export const exportRepayments = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const data = await repaymentService.exportAll({ mode: mode !== "all" ? mode : undefined, dateFrom, dateTo, lenderId, search }, req.adminId!);
        ...
        const rows = (data as Record<string, unknown>[]).map(r => [
            r["Repayment ID"], r["Date"], r["Type"] ?? r["repaymentType"] ?? "Principal",
            r["Lender Name"], r["Lender ID"], r["Amount Paid (Rs.)"] ?? r["amountPaid"],
